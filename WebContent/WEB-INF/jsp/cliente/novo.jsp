...
<div id="search">
	<form action="lista-buscar" method="post">
		<input autocomplete="off" required="required" type="text" name="busca" placeholder="Pesquisar cliente...">
					...
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
							...
							<div class="control-group">
								...
								<div class="controls">
									<input class="telefones" type="text" name="cliente.cliTelefoneFixo" class="span5"
							...
							<div class="control-group">
								...
								<div class="controls">
									<input class="telefones" type="text" name="cliente.cliTelefoneMovel"
										class="span5" placeholder="Ex: (88)9999-9999" />
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" name="cliente.cliEmail" class="span5"
										placeholder="Ex: joao@com.zantoin" />
								</div>
							</div>
						</div>
					</div>
