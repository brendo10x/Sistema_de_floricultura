...
<div id="content">
	...
	<form id="vendedorForm" action="editar" method="post"
					...
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
							...
							<div class="control-group">
								...
								<div class="controls">
									<input name="vendedor.venCpf" id="vendedor_venCpf" type="text" class="span5"
							...
							<div class="control-group">
								...
								<div class="controls">
									<input name="vendedor.venRg" type="text" class="span5"
										value="${vendedor.venRg}" placeholder="Ex: 12345678901" />
								</div>
							</div>


							<input type="hidden" name="vendedor.venId"
								value="${vendedor.venId }" />
				...
				<div class="span12">
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
							...
							<div class="control-group">
								...
								<div class="controls">
									<input name="usuario.usuNome" type="text" class="span20"
										value="${usuario.usuNome }" placeholder="Nome de usuário" />
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input name="usuario.usuSenha" id="senha" type="password" class="span6"
										value="${usuario.usuSenha}" placeholder="Digite senha " />
								</div>
							</div>
							...
							<input name="usuario.usuTipo" type="hidden" value="1" /> <input
								type="hidden" name="usuario.usuId" value="${usuario.usuId }" />
				...
				<div class="span12">
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
							...
							<input type="hidden" name="endereco.endId"
								value="${endereco.endId }" />
